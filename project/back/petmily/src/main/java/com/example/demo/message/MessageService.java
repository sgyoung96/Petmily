...
//	}
	...
	public ArrayList<MessageDto> getByRecieverAndCheckAndAvailablereciever(String loginId, int check){ //check=0 : 안읽은 메세지, check=1: 읽은 메세지
		Member member = new Member(loginId, "", "", "", "", null, "", "", "","");
		ArrayList<Message> list = (ArrayList<Message>)dao.findByRecieverAndCheckAndAvailablereciever(member, check,"A");
		ArrayList<MessageDto> list2 = new ArrayList<MessageDto>();
		for(Message m:list) {
	...
	public ArrayList<MessageDto> getBySenderAndCheckAndAvailablesender(String loginId, int check){ //check=0 : 안읽은 메세지, check=1: 읽은 메세지
		Member member = new Member(loginId, "", "", "", "", null, "", "", "","");
