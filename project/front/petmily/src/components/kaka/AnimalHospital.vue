  ...
  <div id="DetailsItem" style="background-color:#e5e7eb; padding-top:50px; padding-bottom:50px">
    ...
    <div v-for="item in item" :key="item.careNm">
      ...
      <div class="d-card">
        ...
        <div style="display:inline-block">
          <div class="a-card"
            v-if="item.weekOprStime && item.weekOprEtime && item.weekOprStime !== ':' && item.weekOprEtime !== ':'">
            <div class="e-card">
              <img src="../../assets/images/점.png">&nbsp;
              <h3>평일운영시간</h3>
            </div>
          ...
          <div class="a-card"
            v-if="item.weekCellStime && item.weekCellEtime && item.weekCellStime !== ':' && item.weekCellEtime !== ':'">
            <div class="e-card">
              <img src="../../assets/images/점.png">&nbsp;
              <h3>평일분양시간</h3>
            </div>
          ...
          <div class="a-card"
            v-if="item.weekendOprStime && item.weekendOprEtime && item.weekendOprStime !== ':' && item.weekendOprEtime !== ':'">
            <div class="e-card">
              <img src="../../assets/images/점.png">&nbsp;
              <h3>주말운영시간</h3>
            </div>
          ...
          <div class="a-card"
            v-if="item.weekendCellStime && item.weekendCellEtime && item.weekendCellStime !== ':' && item.weekendCellEtime !== ':'">
            <div class="e-card">
              <img src="../../assets/images/점.png">&nbsp;
              <h3>주말분양시간</h3>
            </div>
