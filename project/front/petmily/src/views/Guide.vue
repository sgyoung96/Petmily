<template>
  <div>
      ...
      <div class="slider-2">
          <div class="side-btns">
              <div><span><i class="fas fa-caret-left"><img style="width:50px; height:50px;" src="https://cdn-icons-png.flaticon.com/512/5602/5602104.png"></i></span></div>
              <div><span><i class="fas fa-caret-right"><img style="width:50px; height:50px;" src="https://cdn-icons-png.flaticon.com/512/5602/5602376.png"></i></span></div>
          </div>
      ...
      <div class="rounded">
          ...
          <p class="txt">국내법상으로는 태어난 지 2개월 이후의 반려견만을 입양할 수 있습니다. 최소한의 면역력이 형성되면서 유동식을 먹을 수 있는 나이가 되어야만 입양이 가능한 것인데요. 출생일을
              정확히 잘 모르기 때문에 이 부분은 분양을 하는 분의 말을 전적으로 믿을 수밖에 없습니다.</p>
          <p class="txt"></p>
          <div class="box">
              <span class="img">
          ...
          <div class="box">
              ...
              <div class="txt_wrap">
                  ...
                  <p class="txt">보통의 보호자들은 동물병원에 내원 후, “2차 접종까지 했다고 합니다”라고 이야기하곤 합니다. 그러나 접종의 종류는 혼합백신, 코로나 장염백신,
          ...
          <div class="box">
              ...
              <div class="txt_wrap">
                  ...
                  <p class="txt">
                      ...
                      정도이고요. 추후1주일정도 관리 해보고 발톱깎이, 귀 세정제, 샴푸, 빗, 목걸이, 줄, 이동장, 장난감등의 제품을 구매하는 것이 좋습니다. 또 급하게 구매하기 보다는 입양 후
